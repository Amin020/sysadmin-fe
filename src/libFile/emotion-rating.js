...
(function ($, document, window, undefined) {
  ...
  var emotionsArray = {
    ...
    cat: "&#x1F63A;",
    like:
      "https://media1.tenor.com/images/aaf7f2bb862a0004acad5bff2b08d927/tenor.gif?itemid=10721555",
    dislike:
      "https://media1.tenor.com/images/995a85ec6511d61b23cac5e29676e28e/tenor.gif?itemid=14444528",
  };
        ...
        if (!this.settings.disabled) {
          ...
          this.elementContainer
            ...
            .each(function () {
              ...
              var bgEmotion =
                emotionsArray[content ? content : $this.settings.bgEmotion];
              $(this).html(bgEmotion);
            });
        }
      },
      showEmotion: function (count) {
        ...
        for (var i = 0; i < count; i++) {
          ...
          this.elementContainer
            .find("." + this.styleCode + "")
            .eq(i)
            .html("<img src='" + emotion + "' width='50' height='50' />");
        }
      },
